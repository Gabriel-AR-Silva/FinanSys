...
const submitCreate = () => {
    createForm.transform((data) => ({ ...data, opening_balance: normalizeMoneyInput(data.opening_balance) })).post(route('accounts.store'), {
        preserveScroll: true,
