...
<template>
    <div class="min-h-screen bg-slate-50 text-slate-950">
        ...
        <TsukiOnboarding v-if="$page.props.onboarding" :essential-steps="$page.props.onboarding.essentialSteps" :recommended-steps="$page.props.onboarding.progress" :progress="$page.props.onboarding.progress" :initially-open="$page.props.onboarding.initiallyOpen" />
        <ToastHost />
    </div>
</template>
