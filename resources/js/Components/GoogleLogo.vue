<template>
    <svg viewBox="0 0 24 24" role="img" aria-label="Google" class="h-5 w-5 shrink-0">
        <path fill="#4285F4" d="M21.6 12.23c0-.71-.06-1.4-.19-2.07H12v3.91h5.38a4.6 4.6 0 0 1-2 3.02v2.54h3.24c1.9-1.75 2.98-4.32 2.98-7.4Z" />
