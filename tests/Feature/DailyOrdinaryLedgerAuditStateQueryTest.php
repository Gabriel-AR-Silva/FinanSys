...
class DailyOrdinaryLedgerAuditStateQueryTest extends TestCase
{
    ...
    public function test_unaudited_later_edit_is_flagged_only_after_observation(): void
    {
        $this->travelTo(CarbonImmutable::parse('2026-09-21T15:00:00+00:00'));
        $user = User::factory()->create();
        $account = Account::factory()->for($user)->create();
        ...
        $this->travelTo(CarbonImmutable::parse('2026-09-22T15:00:00+00:00'));
        // Simulate a legacy writer that changes the ledger but omits AuditRecorder.
        $entry->forceFill(['amount' => '180.00', 'occurred_at' => '2026-09-22 12:00:00'])->save();
