...
class CreditCardSchemaTest extends TestCase
{
    ...
    public function test_credit_card_migration_recovers_after_a_partial_mysql_application(): void
    {
        ...
        $migration = require database_path('migrations/2026_09_09_093501_create_credit_card_domain_tables.php');
        $migration->up();
    ...
    public function test_card_charge_migration_recovers_after_a_partial_mysql_application(): void
    {
        ...
        $migration = require database_path('migrations/2026_09_12_000001_create_card_charge_domain_tables.php');
        $migration->up();
        ...
        $this->assertTrue(Schema::hasIndex('card_charge_payment_allocations', 'card_payment_charge_unique', 'unique'));
    }
    ...
    public function test_financial_evaluation_migration_recovers_when_the_final_index_is_missing(): void
    {
        ...
        $migration = require database_path('migrations/2026_09_12_024716_add_revision_to_financial_evaluations_table.php');
        $migration->up();

        $this->assertTrue(Schema::hasIndex('financial_evaluations', 'financial_evaluations_scope_index'));
    }

    public function test_domain_index_names_respect_the_mysql_identifier_limit(): void
    {
        foreach (['card_payment_allocations', 'card_charge_payment_allocations', 'card_advance_allocations', 'financial_evaluations'] as $table) {
