...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('card_advances')) {
        ...
        if (! Schema::hasTable('card_advance_allocations')) {
            Schema::create('card_advance_allocations', function (Blueprint $table) {
                ...
                $table->unique(['user_id', 'card_installment_id'], 'card_advance_user_installment_unique');
                $table->index(['user_id', 'card_installment_id'], 'card_advance_user_installment_index');
            });
        }
    }
